...
CREATE TABLE `private_messages` (
  ...
  KEY `from_id` (`from_id`),
  KEY `to_id` (`to_id`),
  CONSTRAINT `private_messages_ibfk_1` FOREIGN KEY (`from_id`) REFERENCES `users` (`id`),
  CONSTRAINT `private_messages_ibfk_2` FOREIGN KEY (`to_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2023-08-11 19:40:00
